...
def test_retain_log_files(mocker: MockerFixture) -> None:
    path_list = [Path("python_web_service_boilerplate.johnnys-macbook-pro-2017.local.2023-05-01_08-42-03_086829.log")]
    patch = mocker.patch("pathlib.Path.glob", return_value=(element for element in path_list))
    retain_log_files()
    patch.assert_called()
